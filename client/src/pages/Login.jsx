    ...
    <div style={styles.wrapper}>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.header}>
          ...
          <p style={styles.developer}>DEVELOPED BY CA SK KAVINRAJ</p>
        </div>
        ...
        <div style={styles.card}>
          ...
          <button style={{ ...styles.signInBtn, opacity: loading ? 0.7 : 1 }} onClick={handleLogin} disabled={loading}>
            {loading ? "Signing in…" : `Sign In as ${activeTab === "ca" ? "CA" : "Staff"}`}
          </button>

          <p style={styles.hint}>
            {activeTab === "ca"
              ? "Contact the admin CA if you forgot your password."
...
const styles = {
  ...
  container: {
    width: "100%", maxWidth: "480px", padding: "0 16px",
  ...
  tabContainer: {
    ...
    borderRadius: "10px", padding: "4px", width: "100%",
  },
  ...
  card: {
    width: "100%", background: "rgba(255,255,255,0.06)", borderRadius: "16px",
    padding: "28px 24px", backdropFilter: "blur(10px)",
    border: "1px solid rgba(255,255,255,0.08)", display: "flex", flexDirection: "column", gap: "16px",
  },
  fieldGroup: { display: "flex", flexDirection: "column", gap: "6px" },
  label: { color: "#c0d0e0", fontSize: "11px", fontWeight: "600", letterSpacing: "1px" },
  input: {
    background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)",
    borderRadius: "8px", padding: "12px 14px", color: "#e0eaf4", fontSize: "14px",
    outline: "none", width: "100%", boxSizing: "border-box", transition: "border-color 0.2s",
  },
  signInBtn: {
    width: "100%", padding: "14px",
    background: "linear-gradient(90deg, #4da8da, #2e86c1)",
    border: "none", borderRadius: "8px", color: "#ffffff",
    fontSize: "16px", fontWeight: "700", cursor: "pointer", letterSpacing: "0.5px", marginTop: "4px",
  },
